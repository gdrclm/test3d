...
export function buildObject(config = {}) {
  ...
  group.name = "obj_10_right_curtain";
  ...
  const cloth = curtainMesh(0.28, 1.02, 0.09, fabricMain, "right");
  ...
  finalizeGroup(group, {
    ...
    sockets: { curtain_mount_top_right: new THREE.Vector3(0, 1.1, 0) },
    vectorSources: [
      "room_objects_51_images/10_right_curtain_front_view.svg",
      "room_objects_51_images/10_right_curtain_top_view.svg",
      "room_objects_51_images/10_right_curtain_side_view.svg"
    ]
  });
  return group;
}
