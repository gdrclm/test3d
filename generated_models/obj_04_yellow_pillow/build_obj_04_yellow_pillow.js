...
export function buildObject(config = {}) {
  ...
  group.name = "obj_04_yellow_pillow";

  const fabric = makeStandardMaterial(config.fabricMain ?? "#fff1bc", 0.99);
  ...
  finalizeGroup(group, {
    ...
    vectorSources: [
      "room_objects_51_images/04_yellow_pillow_front_view.svg",
      "room_objects_51_images/04_yellow_pillow_top_view.svg",
      "room_objects_51_images/04_yellow_pillow_side_view.svg"
    ]
  });
  return group;
}
