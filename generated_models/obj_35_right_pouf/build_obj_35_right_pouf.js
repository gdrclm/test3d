...
export function buildObject(config = {}) {
  ...
  group.name = "obj_35_right_pouf";

  const fabric = makeStandardMaterial(config.fabricMain ?? "#86d7c0", 0.96);
  ...
  body.name = "svg_profiled_right_pouf_body";
  group.add(body);
  ...
  finalizeGroup(group, {
    ...
    vectorSources: [
      "room_objects_51_images/35_right_pouf_front_view.svg",
      "room_objects_51_images/35_right_pouf_top_view.svg",
      "room_objects_51_images/35_right_pouf_side_view.svg"
    ]
  });
  return group;
}
