# CODEX PROMPT — Декоративный домик/пирамидка на полке / Shelf Decorative House or Pyramid
...
- `displayNameRu`: `Декоративный домик/пирамидка на полке`
- `displayNameEn`: `Shelf Decorative House or Pyramid`
- `category`: `decor`
- `family`: `smallAccent`
...
1. Проанализируй виды и выдели:
   ...
   - uncertain areas
2. Проверь соответствие template `templateSmallDecor`.
...
5. Зарегистрируй:
   ...
   - deform zones
   - animation hooks
6. Соблюди `targetTris = 100` и `maxTris = 180`.
...
- required parts: base, topAccent
- required hooks: shelf_attach_center
- required material slots: plasticMain, woodAccent
