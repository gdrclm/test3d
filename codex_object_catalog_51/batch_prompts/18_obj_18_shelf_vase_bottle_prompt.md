# CODEX PROMPT — Ваза/бутылка на полке / Shelf Vase or Bottle
...
- `displayNameRu`: `Ваза/бутылка на полке`
- `displayNameEn`: `Shelf Vase or Bottle`
- `category`: `decor`
...
1. Проанализируй виды и выдели:
   ...
   - uncertain areas
2. Проверь соответствие template `templateLatheProp`.
...
5. Зарегистрируй:
   ...
   - deform zones
   - animation hooks
6. Соблюди `targetTris = 160` и `maxTris = 320`.
...
- required parts: mainBody, neckOrLip
- required hooks: shelf_attach_center
- required material slots: glass, plasticMain
