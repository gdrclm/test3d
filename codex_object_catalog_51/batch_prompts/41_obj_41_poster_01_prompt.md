# CODEX PROMPT — Первый постер / Poster 01
...
## Текущий объект
- `id`: `obj_41_poster_01`
- `displayNameRu`: `Первый постер`
- `displayNameEn`: `Poster 01`
- `category`: `wallObject`
...
1. Проанализируй виды и выдели:
   ...
   - uncertain areas
2. Проверь соответствие template `templatePoster`.
...
- required parts: posterPlane, graphicZone
- required hooks: wall_mount_center
