# CODEX PROMPT — Круглый игровой столик / Round Play Table
...
- `displayNameRu`: `Круглый игровой столик`
- `displayNameEn`: `Round Play Table`
- `category`: `furniture`
- `family`: `playSurface`
...
```json
{
  ...
  "requiredHooks": [
    "top_surface_center",
    "table_accessory_slot_a",
    "table_accessory_slot_b",
    "table_accessory_slot_c"
  ],
...
1. Проанализируй виды и выдели:
   ...
   - uncertain areas
2. Проверь соответствие template `templateRoundTable`.
...
5. Зарегистрируй:
   ...
   - deform zones
   - animation hooks
6. Соблюди `targetTris = 500` и `maxTris = 900`.
...
- required parts: tableTop, support, base
- required hooks: top_surface_center, table_accessory_slot_a, table_accessory_slot_b, table_accessory_slot_c
- required material slots: woodMain, woodAccent
