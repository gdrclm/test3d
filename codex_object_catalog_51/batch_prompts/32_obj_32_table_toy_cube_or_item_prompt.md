# CODEX PROMPT — Игрушечный кубик/предмет на столике / Toy Cube or Item on Table
...
- `displayNameRu`: `Игрушечный кубик/предмет на столике`
- `displayNameEn`: `Toy Cube or Item on Table`
- `category`: `toy`
...
1. Проанализируй виды и выдели:
   ...
   - uncertain areas
2. Проверь соответствие template `templateSmallProp`.
...
5. Зарегистрируй:
   ...
   - deform zones
   - animation hooks
6. Соблюди `targetTris = 60` и `maxTris = 140`.
...
- required parts: mainMass, accentZone
- required hooks: table_attach_center
- required material slots: plasticMain, fabricAccent
