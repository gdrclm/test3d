# CODEX PROMPT — Прикроватная лампа / Bedside Lamp
...
- `displayNameRu`: `Прикроватная лампа`
- `displayNameEn`: `Bedside Lamp`
- `category`: `lighting`
...
5. Зарегистрируй:
   ...
   - deform zones
   - animation hooks
6. Соблюди `targetTris = 350` и `maxTris = 700`.
...
- required parts: base, stand, shade, bulbSlot
- required hooks: light_emitter, table_attach_center
