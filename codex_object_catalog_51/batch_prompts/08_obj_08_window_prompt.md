...
1. Проанализируй виды и выдели:
   ...
   - uncertain areas
2. Проверь соответствие template `templateWindowFlat`.
...
5. Зарегистрируй:
   ...
   - deform zones
   - animation hooks
6. Соблюди `targetTris = 180` и `maxTris = 360`.
...
- required parts: outerFrame, glassPaneLeft, glassPaneRight, divider
- required hooks: wall_mount_center, curtain_rail_left, curtain_rail_right
- required material slots: paintedFrame, glass
