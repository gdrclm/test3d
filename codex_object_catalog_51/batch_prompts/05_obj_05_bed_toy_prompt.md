# CODEX PROMPT — Игрушка на кровати / Toy on Bed
...
## Текущий объект
- `id`: `obj_05_bed_toy`
- `displayNameRu`: `Игрушка на кровати`
- `displayNameEn`: `Toy on Bed`
- `category`: `toy`
- `family`: `smallProp`
...
- required parts: mainBody, head, accentEars
- required hooks: bed_plush_slot
