...
1. Проанализируй виды и выдели:
   ...
   - uncertain areas
2. Проверь соответствие template `templateBed`.
...
5. Зарегистрируй:
   ...
   - deform zones
   - animation hooks
6. Соблюди `targetTris = 1100` и `maxTris = 1800`.
...
- required parts: frame, mattressZone, blanketZone, pillowSlotLeft, pillowSlotRight
- required hooks: blanket_anchor, pillow_slot_left, pillow_slot_right, plush_slot
- required material slots: woodMain, fabricMain, fabricAccent
