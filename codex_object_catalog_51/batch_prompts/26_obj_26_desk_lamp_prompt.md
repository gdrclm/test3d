# CODEX PROMPT — Настольный светильник / Desk Lamp
...
## Текущий объект
- `id`: `obj_26_desk_lamp`
- `displayNameRu`: `Настольный светильник`
- `displayNameEn`: `Desk Lamp`
- `category`: `lighting`
...
1. Проанализируй виды и выдели:
   ...
   - uncertain areas
2. Проверь соответствие template `templateLamp`.
...
5. Зарегистрируй:
   ...
   - deform zones
   - animation hooks
6. Соблюди `targetTris = 320` и `maxTris = 620`.
...
- required parts: base, stand, headOrShade, lightEmitter
- required hooks: desktop_attach_center, light_emitter, lamp_head_tilt
- required material slots: plasticMain, metalAccent, glass
- deformation profile: rigid
- animation potential: lamp_head_tilt
- notes: Отдельный рабочий светильник для зоны стола.
