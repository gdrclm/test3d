# CODEX PROMPT — Письменный стол / Desk
...
1. Проанализируй виды и выдели:
   ...
   - uncertain areas
2. Проверь соответствие template `templateDesk`.
...
- required parts: tableTop, supportSystem, legSetOrSidePanels
- required hooks: desktop_monitor_slot, desktop_keyboard_slot, desktop_book_slot, desktop_lamp_slot
