...
1. Проанализируй виды и выдели:
   ...
   - uncertain areas
2. Проверь соответствие template `templateEasel`.
...
- required parts: frontLegLeft, frontLegRight, rearLeg, crossBar, canvasSupport
- required hooks: canvas_mount_center, floor_attach
- required material slots: woodMain, woodAccent
- deformation profile: rigid
- animation potential: fold_axis_optional
- notes: Структура стоек должна быть понятной и лёгкой.
