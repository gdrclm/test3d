# CODEX PROMPT — Книги на полках / Books Set
...
## Текущий объект
- `id`: `obj_16_books_set`
- `displayNameRu`: `Книги на полках`
- `displayNameEn`: `Books Set`
- `category`: `decor`
...
1. Проанализируй виды и выдели:
   ...
   - uncertain areas
2. Проверь соответствие template `templateBookCluster`.
...
5. Зарегистрируй:
   ...
   - deform zones
   - animation hooks
6. Соблюди `targetTris = 250` и `maxTris = 550`.
...
- required parts: bookA, bookB, bookC, bookD
- required hooks: shelf_attach_cluster
