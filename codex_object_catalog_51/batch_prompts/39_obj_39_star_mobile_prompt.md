# CODEX PROMPT — Мобиль со звёздами / Star Mobile
...
- `displayNameRu`: `Мобиль со звёздами`
- `displayNameEn`: `Star Mobile`
- `category`: `decor`
- `family`: `hangingDecor`
...
1. Проанализируй виды и выдели:
   ...
   - uncertain areas
2. Проверь соответствие template `templateMobile`.
...
5. Зарегистрируй:
   ...
   - deform zones
   - animation hooks
6. Соблюди `targetTris = 250` и `maxTris = 500`.
...
- required parts: topRig, hangerA, hangerB, starA, starB, starC
- required hooks: ceiling_mount, mobile_swing_root
- required material slots: metalAccent, plasticMain
- deformation profile: semiSoft
- animation potential: mobile_swing_root, star_secondary_sway
- notes: Отдельные подвесы обязательны для лёгкой анимации.
