...
1. Проанализируй виды и выдели:
   ...
   - uncertain areas
2. Проверь соответствие template `templateDoorFlat`.
...
5. Зарегистрируй:
   ...
   - deform zones
   - animation hooks
6. Соблюди `targetTris = 220` и `maxTris = 420`.
...
- required parts: doorLeaf, knobOrHandle
- required hooks: door_hinge_side, door_handle_center
- required material slots: woodMain, metalAccent
- deformation profile: rigid
- animation potential: door_swing_hinge
- notes: Плоская дверная створка с минимальной толщиной.
