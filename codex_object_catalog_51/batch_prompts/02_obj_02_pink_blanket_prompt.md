# CODEX PROMPT — Розовое одеяло / Pink Blanket
...
- `displayNameRu`: `Розовое одеяло`
- `displayNameEn`: `Pink Blanket`
- `category`: `textile`
- `family`: `bedTextile`
...
1. Проанализируй виды и выдели:
   ...
   - uncertain areas
2. Проверь соответствие template `templateSoftSurface`.
...
- required parts: blanketBody, topFold, sideDrape
- required hooks: bed_attach_zone
