# CODEX PROMPT — Домашние тапочки / Slippers
...
## Текущий объект
- `id`: `obj_49_slippers`
- `displayNameRu`: `Домашние тапочки`
- `displayNameEn`: `Slippers`
...
1. Проанализируй виды и выдели:
   ...
   - uncertain areas
2. Проверь соответствие template `templateSlippersPair`.
...
- required parts: leftSlipper, rightSlipper
- required hooks: floor_attach_pair
