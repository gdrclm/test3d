# CODEX PROMPT — Правая штора / Right Curtain
...
- `displayNameRu`: `Правая штора`
- `displayNameEn`: `Right Curtain`
- `category`: `textile`
- `family`: `wallTextile`
...
1. Проанализируй виды и выдели:
   ...
   - uncertain areas
2. Проверь соответствие template `templateCurtain`.
...
5. Зарегистрируй:
   ...
   - deform zones
   - animation hooks
6. Соблюди `targetTris = 280` и `maxTris = 560`.
...
- required parts: clothBody, topGather, waveProfile
- required hooks: curtain_mount_top_right
- required material slots: fabricMain
- deformation profile: semiSoft
- animation potential: curtain_wave_root
- notes: Зеркальная пара левой шторы.
