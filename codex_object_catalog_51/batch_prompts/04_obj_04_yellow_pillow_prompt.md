# CODEX PROMPT — Жёлтая подушка / Yellow Pillow
...
- `displayNameRu`: `Жёлтая подушка`
- `displayNameEn`: `Yellow Pillow`
- `category`: `textile`
- `family`: `softProp`
...
1. Проанализируй виды и выдели:
   ...
   - uncertain areas
2. Проверь соответствие template `templatePillow`.
...
5. Зарегистрируй:
   ...
   - deform zones
   - animation hooks
6. Соблюди `targetTris = 280` и `maxTris = 500`.
...
- required parts: pillowMass, seamHint
- required hooks: bed_pillow_slot
