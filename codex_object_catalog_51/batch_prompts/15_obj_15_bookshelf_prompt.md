# CODEX PROMPT — Книжный шкаф / Bookshelf
...
1. Проанализируй виды и выдели:
   ...
   - uncertain areas
2. Проверь соответствие template `templateBookshelf`.
...
5. Зарегистрируй:
   ...
   - deform zones
   - animation hooks
6. Соблюди `targetTris = 1000` и `maxTris = 1800`.
...
- required parts: frame, shelfTop, shelfMid, shelfBottom, backPanelOptional
- required hooks: shelf_socket_01, shelf_socket_02, shelf_socket_03, top_surface_center
